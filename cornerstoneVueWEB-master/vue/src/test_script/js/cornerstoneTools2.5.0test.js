...
function updatePerpendicularLineHandles (eventData, data) {
    ...
    let startX, startY, endX, endY,startX2, startY2, endX2, endY2;
    ...
    if (start.x === end.x && start.y === end.y) {
        ...
        endX2 = mid.x2 - (perpendicularLineLength2 / 2) * vectorY;
        endY2 = mid.y2 + (perpendicularLineLength2 / 2) * vectorX;
    }
...
function drawPerpendicularLine (context, element, data, color, lineWidth) {
    // Draw perpendicular line
    var { perpendicularStart, perpendicularEnd, perpendicularStart2, perpendicularEnd2} = data.handles;
...
function calculateLongestAndShortestDiameters (eventData, measurementData) {
    var { rowPixelSpacing, columnPixelSpacing } = eventData.image;
    var { start, end, perpendicularStart, perpendicularEnd, perpendicularStart2, perpendicularEnd2 } = measurementData.handles;
	...
	measurementData.shortestDiameter2 = width2.toFixed(1);
	measurementData.ctr = Math.round(width2.toFixed(1)/width.toFixed(1)*100)/100;
}
