...
public class SegMCRebuild {
    ...
    public SegMCRebuild(String inputfilename, String outputfilename){
...
//        D:\test1\test\H0002\2020-06\08\H0002CT000556\1.2.392.200036.9116.2.5.1.48.1224104417.1313478430.414393\1.2.392.200036.9116.2.1224104417.1313478696.2.1010300001.1
        ...
        actor.GetProperty().SetOpacity(2.0);//透明度；
...
//        return "EXIT_SUCCESS";
    ...
    public static void main(String[] args) {
        SegMCRebuild segMCRebuild=new SegMCRebuild("","D:\\img\\polywrite3");
        segMCRebuild.restructing();
    }
}
